		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#waterworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"waterworkflowuimodule-display": {
								"semanticObject": "waterworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=waterworkflowuimodule",
									"url": sap.ui.require.toUrl("waterworkflowuimodule")
								}
							}
						}
					}
